...
This guide covers the print setup for all 3D-printed parts of the hand exoskeleton. The Bambu Studio `.3mf` project file is configured for the **Bambu Lab P1S** and is available in `Print Files/BambuStudio/`. It is recommended to view the print in **Line Type** color scheme in Bambu Studio to distinguish support structures from actual part filament before printing.
...
All parts fit onto a **single Bambu Lab P1S print bed** (256 mm × 256 mm). The `.3mf` project file in `Print Files/BambuStudio/` has all parts pre-arranged and pre-configured.
...
<p align="center">
  <img src="screenshots/Hand_Exo_Full_Bed_Slice.png" alt="Full bed slice view in Bambu Studio" width="800"/>
</p>
